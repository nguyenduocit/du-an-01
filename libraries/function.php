<?php
	...
	*/
    ...
    function url()
    {
        return $link = "http://".$_SERVER['SERVER_NAME'].'/'.NAME_PROJECT;
    }
    ...
    */
    ...
    /**
    *	 Hàm cắt chuỗi lấy ra từ chuỗi 
    *    @param $text chuỗi cần cắt 
    *    @param $num số ký tự cần cắt 
    *    @return   $text chuỗi sau khi cắt
    */
