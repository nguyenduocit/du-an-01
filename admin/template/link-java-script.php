...
<script src="<?php echo url() ?>/public/plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo url() ?>/public/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="<?php echo url() ?>/public/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo url() ?>/public/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo url() ?>/public/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
...
<script src="<?php echo url() ?>/public/style/js/main.js"></script>